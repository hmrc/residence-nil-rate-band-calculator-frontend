...
trait PDFHelper {
  ...
  private def setupPDFDocument(pdf: PDDocument)(using Lang): Unit = {
  ...
  def generatePDF(cacheMap: CacheMap, generateWelshPDF: Boolean)(using Lang): Option[ByteArrayOutputStream] = {
