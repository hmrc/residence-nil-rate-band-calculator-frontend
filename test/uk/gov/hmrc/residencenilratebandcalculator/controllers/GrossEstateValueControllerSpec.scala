...
class GrossEstateValueControllerSpec extends SimpleControllerSpecBase {
  ...
  "Gross Estate Value Controller" must {
    ...
    behave like nonStartingController[Int](createController, List(Constants.dateOfDeathId, Constants.anyEstatePassedToDescendantsId))(Reads.IntReads, Writes.IntWrites)
  }
}
