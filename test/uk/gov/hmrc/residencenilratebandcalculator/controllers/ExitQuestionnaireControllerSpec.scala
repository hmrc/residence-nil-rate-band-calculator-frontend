...
class ExitQuestionnaireControllerSpec extends HtmlSpec with WithFakeApplication {
  ...
  "Exit Questionnaire controller" must {
    ...
    "return 200 for a GET" in {
      val result = new ExitQuestionnaireController(frontendAppConfig, messagesApi, navigator).onPageLoad()(fakeRequest)
